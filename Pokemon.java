...
public class Pokemon {
	...
	public Pokemon(String name, String type1, String type2) {
		if(!this.setAll(name, type1, type2)) {
			if (!this.setAll(name, type1, type2)) {
				throw new IllegalArgumentException("ERROR: Invalid Pokémon name or type entered.");
			}
		}
	}
	...
	public Pokemon(Pokemon p) throws IllegalArgumentException {
		if (p == null) {
			throw new IllegalArgumentException("ERROR: Pokémon copy constructor illegal argument (null) passed.");
		}
